...
// Şirket panelinin kendi kapısı.
//
// PanelLogin'den kopyalandı, import edilmedi. Ayrı olan ekran, oturum değil:
// token seti ürünle aynı (mf_access / mf_refresh). Kayıt bağlantısı yok —
// bu ekranın işi hesap açmak değil.
    ...
    <div className="min-h-screen grid place-items-center p-5">
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <div className="font-display text-lg tracking-tight">Şirket</div>
